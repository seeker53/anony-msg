                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <Input {...field} className="border rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-400" />
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            >
                                {isLoading ? 'Resending...' : countdown !== null ? `Resend in ${countdown} s` : 'Resend Code'}
                            </Button>
